    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="flex items-center justify-between mb-12 pb-6 border-b border-slate-800">
        ...
        <button
          ...
          disabled={loggingOut}
          className="flex items-center gap-2 text-slate-400 hover:text-red-400 transition-colors text-sm font-medium px-4 py-2 hover:bg-slate-900 rounded-lg"
        >
          ...
          {activeTab === 'status' && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
               <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl text-center">
                  <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${hasConnection ? 'bg-green-500/10 text-green-500' : 'bg-slate-800 text-slate-500'}`}>
                    {hasConnection ? (
